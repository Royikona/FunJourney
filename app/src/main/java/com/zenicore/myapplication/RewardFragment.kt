...
import com.zenicore.myapplication.databinding.FragmentRewardBinding
...
class RewardFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.points.root.setOnClickListener {
            val intent = Intent(activity, PointActivity::class.java)
            startActivity(intent)
        }
        binding.cardundangteman.root.setOnClickListener {
            val intent = Intent(activity, InviteActivity::class.java)
            startActivity(intent)
        }
        binding.cardLihatPenawaran.root.setOnClickListener {
