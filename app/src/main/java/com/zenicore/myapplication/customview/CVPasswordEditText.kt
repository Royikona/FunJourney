package com.zenicore.myapplication.customview
...
import com.zenicore.myapplication.R
...
class CVPasswordEditText : AppCompatEditText {
    ...
    override fun onDraw(canvas: Canvas) {
        super.onDraw(canvas)
        context.apply {
            setTextColor(ContextCompat.getColor(this, R.color.blueish))
            setHintTextColor(ContextCompat.getColor(this, R.color.blueish))
